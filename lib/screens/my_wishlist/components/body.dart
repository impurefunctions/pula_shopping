...
import 'package:e_commerce_app_flutter/screens/home/components/product_type_box.dart';
...
import 'package:e_commerce_app_flutter/screens/home/components/products_section.dart';
import '../../../utils.dart';
...
class _BodyState extends State<Body> {
  final productCategories = <Map>[
    ...
    <String, dynamic>{
      ICON_KEY: "assets/icons/car open.svg",
      TITLE_KEY: "Car Spares",
          ...
          if (cartItemsId.length == 0) {
            return Center(
              child: NothingToShowContainer(
                ...
                secondaryMessage: "Your wish list is empty",
              ),
            );
          }
